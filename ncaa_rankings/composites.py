...
SIDEARM_COMPOSITES: dict[str, CompositeDef] = {
    ...
    "football": CompositeDef(
        weights={
            "passing_stats_passing_yards": 1.0,
            "passing_stats_passing_touchdowns": 1.0,
            "rushing_stats_rushing_yards": 1.0,
            "rushing_stats_rushing_touchdowns": 0.9,
            "receiving_stats_receiving_yards": 0.9,
            "receiving_stats_receiving_touchdowns": 0.8,
            "defensive_stats_tackles": 0.7,
            "defensive_stats_sacks": 0.8,
            "defensive_stats_interceptions": 0.9,
            "turnovers": -0.7,
        }
    ),
    "mgolf": CompositeDef(
